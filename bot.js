                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~♥️🕊️______ ✰ɪᴀͥᴍ ͣᴀͫʙᴜ ʙᴏᴛ✰ _____🕊️♥️~*' +
                                    '\n\n*🧞‍♂️ ' + error + '*\n\n Max Error oyvakkan Subscribe cheyyu https://instagram.com/_bob_oxo?utm_medium=copy_link'
                                    , MessageType.text);
                            }
                            if (error.message.includes('URL')) {
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ HATA ÇÖZÜMLEME [♥️🕊️______ ✰ɪᴀͥᴍ ͣᴀͫʙᴜ ʙᴏᴛ✰ _____🕊️♥️] ⚕️*' + 
                                        '\n========== ```Hata Okundu!``` ==========' +
                                        '*\n\n Max Error oyvakkan Subscribe cheyyu https://instagram.com/_bob_oxo?utm_medium=copy_link' +
                                    ...
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ ERROR ANALYSIS [♥️🕊️______ ✰ɪᴀͥᴍ ͣᴀͫʙᴜ ʙᴏᴛ✰ _____🕊️♥️] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
                                        '*\n\n Max Error oyvakkan Subscribe cheyyu https://instagram.com/_bob_oxo?utm_medium=copy_link' +
